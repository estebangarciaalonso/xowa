...
import gplx.dbs.*;
public class Xodb_tbl_category {
	...
	public Xodb_itm_category Select(Db_provider p, int cat_page_id) {
		...
		try {
			...
			if (rdr.MoveNextPeer()) {
				return	Xodb_itm_category.load_
					(	cat_page_id
	...
	public static Xodb_itm_category Read_ctg(DataRdr rdr) {
		return Xodb_itm_category.load_
		(	rdr.ReadInt(Xodb_tbl_category.Fld_cat_id)
		,	rdr.ReadInt(Xodb_tbl_category.Fld_cat_file_idx)
		,	rdr.ReadByte(Xodb_tbl_category.Fld_cat_hidden) == Bool_.Y_byte
		,	rdr.ReadInt(Xodb_tbl_category.Fld_cat_subcats)
		,	rdr.ReadInt(Xodb_tbl_category.Fld_cat_files)
		,	rdr.ReadInt(Xodb_tbl_category.Fld_cat_pages)
		);		
	}
