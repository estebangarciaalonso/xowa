...
public class Xow_lang_mgr_tst {
	...
	@Test  public void Basic() {
		fxt.tst("[[simple:Earth]] [[fr:Terre]] [[es:Tierra]] [[de:Erde]] [[it:Terre]]", String_.Concat_lines_nl_skipLast
			(	"<div id=\"xowa-lang\">"
	...
	@Test  public void Empty() {
		fxt.tst("[[simple:]]", String_.Concat_lines_nl_skipLast
			(	"<div id=\"xowa-lang\">"
			,	"  <h5>In other languages</h5>"
			,	"  <h4>grp1</h4>"
			,	"  <table style='width: 100%;'>"
...
//			fxt.Wiki().Xwiki_mgr().Add_full(ByteAry_.new_utf8_("zh"), ByteAry_.new_utf8_("zh.wikipedia.org"), ByteAry_.new_utf8_("http://zh.wikipedia.org/~{0}"));
		fxt.tst("[[zh:Earth]]", String_.Concat_lines_nl_skipLast
			(	"<div id=\"xowa-lang\">"
			,	"  <h5>In other languages</h5>"
			,	"  <h4>grp1</h4>"
			,	"  <table style='width: 100%;'>"
