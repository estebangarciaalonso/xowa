...
public class Xoa_url_alias_mgr implements GfoInvkAble {
	Hash_adp_bry hash = new Hash_adp_bry(true); ByteAryFmtr fmtr = ByteAryFmtr.new_("", "");
	...
	public byte[] Get_wiki(byte[] alias) {return (byte[])hash.Get_by_bry(alias);}
	public byte[] Get_wiki(byte[] src, int bgn, int end) {return (byte[])hash.Get_by_mid(src, bgn, end);}
