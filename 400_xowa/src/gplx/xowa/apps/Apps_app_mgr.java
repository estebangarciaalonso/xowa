...
public class Apps_app_mgr implements GfoInvkAble {
	public Apps_app_mgr(Xoa_app app) {this.app = app;} private Xoa_app app;
	public void Init() {
		...
		ProcessAdp.ini_(this, app.Gui_wtr(), app_lilypond				, cmd_eval, ProcessAdp.Run_mode_sync_timeout	,  1 * 60, "~{<>bin_plat_dir<>}lilypond\\usr\\bin\\lilypond", "\"-dsafe=#t\" -dbackend=ps --png --header=texidoc -dmidi-extension=midi \"~{file}\"", "file");
		ProcessAdp.ini_(this, app.Gui_wtr(), app_abc2ly					, cmd_eval, ProcessAdp.Run_mode_sync_timeout	,  1 * 60, "~{<>bin_plat_dir<>}lilypond\\usr\\bin\\python", "abc2ly.py -s \"--output=~{target}\" \"~{source}\"", "source", "target");
	...
	static final String Invk_query_img_size = "query_img_size", Invk_resize_img = "resize_img", Invk_convert_svg_to_png = "convert_svg_to_png", Invk_convert_tex_to_dvi = "convert_tex_to_dvi", Invk_convert_dvi_to_png = "convert_dvi_to_png"
		, Invk_convert_djvu_to_tiff = "convert_djvu_to_tiff", Invk_tidy_html = "tidy_html", Invk_view_web = "view_web", Invk_decompress_bz2 = "decompress_bz2", Invk_decompress_zip = "decompress_zip", Invk_view_by_ext = "view_by_ext"
