...
public class Xob_xfer_regy_tbl {
	...
	,	", lnki_thumbtime      integer             NOT NULL"
	...
	, ", file_is_orig, orig_w, orig_h, -1, -1, lnki_thumbtime, Sum(lnki_count)"
	, ", 0"
	, "FROM    xfer_temp x"
	, "WHERE   file_is_orig = 1"
	, "GROUP BY orig_repo, lnki_ttl, lnki_ext, orig_media_type, file_is_orig, orig_w, orig_h, lnki_thumbtime"
	);
	...
	, ", file_is_orig, orig_w, orig_h, file_w, file_h, lnki_thumbtime, Sum(lnki_count)"
	, ", 0"
	, "FROM    xfer_temp x"
	, "WHERE   file_is_orig = 0"
	, "GROUP BY orig_repo, lnki_ttl, lnki_ext, orig_media_type, file_is_orig, orig_w, orig_h, file_w, file_h, lnki_thumbtime"
	);
