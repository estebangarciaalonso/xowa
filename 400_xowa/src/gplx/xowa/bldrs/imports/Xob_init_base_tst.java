...
public class Xob_init_base_tst {
	...
	@Test  public void Dirty_wiki_itms() {
		...
		Xohp_wikis_mgr wikis_list = fxt.App().Gui_mgr().Html_mgr().Portal_mgr().Wikis();
		...
		Tfds.Eq("\n        <li><a href=\"/site/en.wikipedia.org/wiki\">en.wikipedia.org</a></li>", wikis_list.Itms_as_html());	// no longer empty
	}
}
