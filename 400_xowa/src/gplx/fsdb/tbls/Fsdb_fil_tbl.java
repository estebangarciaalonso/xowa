...
public class Fsdb_fil_tbl {
	...
	public static void Insert(Db_provider p, int id, int owner_id, String name, int ext_id) {
		Db_stmt stmt = Insert_stmt(p);
		try {Insert(stmt, id, owner_id, name, ext_id);}
		finally {stmt.Rls();}
	}
	private static Db_stmt Insert_stmt(Db_provider p) {return Db_stmt_.new_insert_(p, Tbl_name, Fld_fil_id, Fld_fil_owner, Fld_fil_ext_id, Fld_fil_name);}
	private static void Insert(Db_stmt stmt, int id, int owner_id, String name, int ext_id) {
		stmt.Clear()
		.Val_int_(id)
		.Val_int_(owner_id)
		.Val_int_(ext_id)
	...
	public static final String Tbl_name = "fsdb_fil", Fld_fil_id = "fil_id", Fld_fil_owner = "fil_owner", Fld_fil_name = "fil_name", Fld_fil_ext_id = "fil_ext_id";
