...
public class Scrib_lua_process_rdr {
	public Scrib_lua_process_rdr(byte[] bry_header, byte[] bry_body) {this.bry_header = bry_header; this.bry_body = bry_body;} private byte[] bry_header, bry_body;
