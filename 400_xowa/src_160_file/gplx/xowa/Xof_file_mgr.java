...
public class Xof_file_mgr implements GfoInvkAble {
	public void Init_app(Xoa_app app, Gfo_usr_dlg usr_dlg) {
		this.app = app;
		img_mgr.Init_app(app); repos = new Xof_repo_mgr(app); 
		math_mgr = new Xof_math_mgr(app);
		math_mgr.Init(app);
		download_mgr = new Xoaf_download_mgr(app);
	}
	public Xoa_app App() {return app;} private Xoa_app app;
	public Xof_repo_mgr	Repos() {return repos;} private Xof_repo_mgr repos;
	...
	public Object Invk(GfsCtx ctx, int ikey, String k, GfoMsg m) {
		if		(ctx.Match(k, Invk_repos))				return repos;
