...
public class Fsdb_vlm_data_tst {
	private Fsdb_vlm_data_fxt fxt = new Fsdb_vlm_data_fxt();
...
//			Fsdb_wmf_img_itm img = fxt.Test_img_select(fil.Id(), 1000, 3, Bool_.Y, 1000, 800);
...
//			Fsdb_dir_itm dir = fxt.Test_dir_select("enwiki", 1, 0);
//			Fsdb_fil_itm fil = fxt.Test_fil_select(dir.Id(), "A.png", 2);
//			Fsdb_wmf_img_itm img = fxt.Test_img_select(fil.Id(), 500, 4, Bool_.N, 500, 400);
//			fxt.Test_bin_select(img.Id(), "a500");
//			fxt.Test_cfg_select_next_id(7);
//		}
	@Test   public void Img_delete() {
		if (Xo_test.Db_skip) return;
		Fsdb_wmf_img_itm img_400 = Fsdb_wmf_img_itm.new_(), img_200 = Fsdb_wmf_img_itm.new_();
