...
, Tid_languages = 93
	;
	public static final int _MaxLen = 94;
...
, Tag_caption = new_(Tid_caption, "caption").NoInline_()
...
, Tag_poem = new_(Tid_poem, "poem").Xtn_()
, Tag_math = new_(Tid_math, "math").Xtn_()
, Tag_ref = new_(Tid_ref, "ref").XtnTmpl_().Nest_()
, Tag_references = new_(Tid_references, "references").XtnTmpl_().Nest_()
...
, Tag_script = new_(Tid_script, "script").Restricted_()
, Tag_style = new_(Tid_style, "style").Restricted_()
, Tag_form = new_(Tid_form, "form").Restricted_()
