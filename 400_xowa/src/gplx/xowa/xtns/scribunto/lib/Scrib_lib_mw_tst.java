...
public class Scrib_lib_mw_tst {
	...
	@Test  public void CallParserFunction() {
		fxt.Init_page("{{#invoke:Mod_0|Prc_0}}");
		fxt.Test_lib_proc_kv(lib, Scrib_lib_mw.Invk_callParserFunction, Scrib_kv_utl_.base1_many_ary_("current", "#tag", "b")												, "<b></b>");				// named: args is scalar
		fxt.Test_lib_proc_kv(lib, Scrib_lib_mw.Invk_callParserFunction, Scrib_kv_utl_.base1_many_ary_("current", "#tag", Scrib_kv_utl_.base1_many_("b", "text", "id=1"))	, "<b id=\"1\">text</b>");	// named: args is table
		...
		fxt.Test_lib_proc(lib, Scrib_lib_mw.Invk_callParserFunction, Object_.Ary("current", "#tag", Scrib_kv_utl_.base1_many_("b", "text", "id=1"))	, "<b id=\"1\">text</b>");	// list: args is table
		...
		fxt.Test_lib_proc_kv(lib, Scrib_lib_mw.Invk_callParserFunction, Scrib_kv_utl_.flat_many_(1, "current", 2, "#tag", 3, Scrib_kv_utl_.flat_many_("3", "id=1", "2", "text", "1", "b")), "<b 3=\"id=1\">2=text</b>");// named: sort args; NOTE: keys should probably be stripped
	}
