...
public class Xoh_dom_tst {
	...
	void tst_Find(String src, String where_nde, String where_key, String where_val, String select_key, String expd) {
	...
	void Title_by_href_tst(String href, String html_src, String expd) {
