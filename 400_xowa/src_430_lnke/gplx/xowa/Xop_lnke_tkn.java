...
class Xop_lnke_end_lxr implements Xop_lxr {//20111222
	...
	public int MakeTkn(Xop_ctx ctx, Xop_tkn_mkr tkn_mkr, Xop_root_tkn root, byte[] src, int srcLen, int bgnPos, int curPos) {return ctx.Lnke().MakeTkn_end(ctx, tkn_mkr, src, srcLen, bgnPos, curPos);}
