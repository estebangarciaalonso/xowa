...
public class Pft_func_formatdate extends Pf_func_base {
	...
	@Override public void Func_evaluate(Xop_ctx ctx, byte[] src, Xot_invk caller, Xot_invk self, ByteAryBfr bfr) {
		...
		DateAdp date = Pft_func_time.ParseDate(date_ary, false, ctx.App().Utl_bry_bfr_mkr().Get_b512().Mkr_rls());
		if (date == null) {bfr.Add(date_ary); return;}	// date not parseable; return self; DATE:2014-04-13
		...
		Object o = trie.MatchAtCur(fmt_ary, 0, fmt_ary_len);
		if (o == null 
