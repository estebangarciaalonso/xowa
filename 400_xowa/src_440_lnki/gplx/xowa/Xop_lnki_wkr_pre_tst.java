...
public class Xop_lnki_wkr_pre_tst {		
	...
	@Test  public void Current_pre() {	// PURPOSE: current pre should exist if not div; DATE:2014-02-17
		...
		,	"</p>"
		,	""
		,	"<pre><a href=\"/wiki/File:A.png\" class=\"image\" xowa_title=\"A.png\"><img id=\"xowa_file_img_0\" alt=\"\" src=\"file:///mem/wiki/repo/trg/orig/7/0/A.png\" width=\"0\" height=\"0\" /></a>"	// NOTE: do not capture " "; confirmed against MW; DATE:2014-02-19
		,	"</pre>"
		,	""
		,	"<p>b"
		,	"</p>"
	...
	private static final String Html_A_png = String_.Concat_lines_nl_skipLast
