...
public class Base32Converter {
	public static String EncodeString(String orig) {return Encode(Encoding_.XtoByteAry(orig));}
	...
	public static String DecodeString(String orig) {return Encoding_.XtoStr(Decode(orig));}
