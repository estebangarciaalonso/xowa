...
public abstract class Json_itm_base implements Json_itm {
	...
	public String Print_as_json() {ByteAryBfr bfr = ByteAryBfr.new_(); Print_as_json(bfr, 0); return bfr.XtoStrAndClear();}
	public abstract void Print_as_json(ByteAryBfr bfr, int depth);
