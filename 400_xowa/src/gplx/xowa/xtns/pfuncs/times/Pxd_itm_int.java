...
class Pxd_itm_int extends Pxd_itm_base {
	...
	private void Eval_unknown_at_pos_0(Pxd_parser state) {	// NOTE: assumes dmy format
		Pxd_itm[] data_ary = state.Data_ary();
		if (state.Data_ary_len() < 2) {state.Err_set(Pft_func_time_log.Invalid_year, ByteAryFmtrArg_.int_(val)); return;}
		Pxd_itm_int itm_1 = Pxd_itm_int_.CastOrNull(data_ary[1]);
...
class Pxd_itm_int_ {
	...
	public static boolean Year_err(Pxd_parser state, Pxd_itm_int itm) {
		...
		state.Err_set(Pft_func_time_log.Invalid_year, ByteAryFmtrArg_.int_(val));
		return true;
	}
	public static boolean Month_err(Pxd_parser state, Pxd_itm_int itm) {
		...
		state.Err_set(Pft_func_time_log.Invalid_month, ByteAryFmtrArg_.int_(val));
		return true;
	}
	public static boolean Day_err(Pxd_parser state, Pxd_itm_int itm) {
		...
		state.Err_set(Pft_func_time_log.Invalid_day, ByteAryFmtrArg_.int_(val));
		return true;
	}
	public static boolean Hour_err(Pxd_parser state, Pxd_itm_int itm) {
		...
		state.Err_set(Pft_func_time_log.Invalid_hour, ByteAryFmtrArg_.int_(val));
		return true;
	}
	public static boolean Min_err(Pxd_parser state, Pxd_itm_int itm) {
		...
		state.Err_set(Pft_func_time_log.Invalid_minute, ByteAryFmtrArg_.int_(val));
		return true;
	}
	public static boolean Sec_err(Pxd_parser state, Pxd_itm_int itm) {
		...
		state.Err_set(Pft_func_time_log.Invalid_second, ByteAryFmtrArg_.int_(val));
		return true;
	}
}