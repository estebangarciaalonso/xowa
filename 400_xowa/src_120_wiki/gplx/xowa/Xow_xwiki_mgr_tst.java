...
public class Xow_xwiki_mgr_tst {
	...
	@Test  public void Add_bulk_wiki_en() 						{fxt.Tst_add_bulk("w|en.wikipedia.org"				, Xol_lang_itm_.Id__null		, Xow_wiki_type_.Tid_wikipedia		, "w"			, "http://en.wikipedia.org/wiki/~{0}", "en.wikipedia.org");}
	...
	@Test  public void Add_bulk_wikt_en() 						{fxt.Tst_add_bulk("wikt|en.wiktionary.org"			, Xol_lang_itm_.Id__null		, Xow_wiki_type_.Tid_wiktionary		, "wikt"		, "http://en.wiktionary.org/wiki/~{0}", "en.wiktionary.org");}
	@Test  public void Add_bulk_commons() 						{fxt.Tst_add_bulk("commons|commons.wikimedia.org"	, Xol_lang_itm_.Id__null		, Xow_wiki_type_.Tid_commons		, "commons"		, "http://commons.wikimedia.org/wiki/~{0}", "commons.wikimedia.org");}
	@Test  public void Add_bulk_commons_cap() 					{fxt.Tst_add_bulk("Commons|commons.wikimedia.org"	, Xol_lang_itm_.Id__null		, Xow_wiki_type_.Tid_commons		, "Commons"		, "http://commons.wikimedia.org/wiki/~{0}", "commons.wikimedia.org");}
...
class Xow_xwiki_mgr_fxt {
	...
	public Xow_xwiki_itm xwiki_null_(String key) {return new Xow_xwiki_itm(ByteAry_.new_utf8_(key), ByteAry_.Empty, Xow_wiki_type_.Tid_custom, Xol_lang_itm_.Id__null, ByteAry_.Empty);}
	public Xow_xwiki_itm xwiki_(String key, String domain, String fmt) {return new Xow_xwiki_itm(ByteAry_.new_utf8_(key), ByteAry_.new_utf8_(fmt), Xow_wiki_type_.Tid_custom, Xol_lang_itm_.Id__null, ByteAry_.new_utf8_(domain));}
