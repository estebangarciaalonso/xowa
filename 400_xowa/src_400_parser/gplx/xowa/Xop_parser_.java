...
public class Xop_parser_ {
	...
	private static ByteTrieMgr_fast anchorencode_trie, poem_trie;
	...
	public static ByteTrieMgr_fast new_trie_tmpl_(Xow_wiki wiki) {
		ByteTrieMgr_fast tmpl_trie = ByteTrieMgr_fast.cs_();
	...
	public static ByteTrieMgr_fast new_trie_wiki_(Xow_wiki wiki) {
