...
class Xob_image_ext_calc_fxt {
	...
	public Xob_image_ext_calc_fxt Name_(String v) {name = ByteAry_.new_ascii_(v); return this;}
	public Xob_image_ext_calc_fxt Media_type_(String v) {media_type = ByteAry_.new_ascii_(v); return this;}
	public Xob_image_ext_calc_fxt Minor_mime_(byte[] v) {minor_mime = v; return this;}
	public Xob_image_ext_calc_fxt Minor_mime_(String v) {return Minor_mime_(ByteAry_.new_ascii_(v));}
