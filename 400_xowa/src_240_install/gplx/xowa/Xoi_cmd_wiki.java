...
class Xoi_cmd_wiki_download extends Gfo_thread_cmd_download implements Gfo_thread_cmd {	public static final String KEY_dump = "wiki.download";
	...
	@gplx.Virtual public String Download_file_ext() {return ".xml";}	// wiki.download is primarily used for dump files; default to .xml.bz2
	...
	@Override public byte Async_init() {
		...
		Xow_wiki wiki = app.Wiki_mgr().Get_by_key_or_make(dump_file.Wiki_type().Domain());
...
class Xoi_cmd_imageMagick_download extends Gfo_thread_cmd_download implements Gfo_thread_cmd {	private static final byte[] Bry_windows_zip = ByteAry_.new_ascii_("-x86-windows.zip");
	static final String Src_imageMagick = "http://www.imagemagick.org/download/binaries/";
