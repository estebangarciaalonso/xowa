...
public interface Xol_case_itm {
	...
	byte[] Src_ary();
	byte[] Trg_ary();
	void Case_build_upper(ByteAryBfr bfr);
	void Case_build_lower(ByteAryBfr bfr);
...
class Xol_case_itm_byt implements Xol_case_itm {
	...
	public void Case_build_upper(ByteAryBfr bfr) {bfr.Add_byte(upper_byte);} private byte upper_byte;
	public void Case_build_lower(ByteAryBfr bfr) {bfr.Add_byte(lower_byte);} private byte lower_byte;
...
class Xol_case_itm_ary implements Xol_case_itm {
	...
	public byte[] Src_ary() {return src_ary;} private byte[] src_ary;
	public byte[] Trg_ary() {return trg_ary;} private byte[] trg_ary;
	public void Case_build_upper(ByteAryBfr bfr) {bfr.Add(upper_ary);} private byte[] upper_ary;
	public void Case_build_lower(ByteAryBfr bfr) {bfr.Add(lower_ary);} private byte[] lower_ary;
