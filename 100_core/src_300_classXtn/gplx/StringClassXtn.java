...
public class StringClassXtn extends ClassXtn_base implements ClassXtn {
	...
	public boolean Eq(Object lhs, Object rhs) {try {return String_.Eq(String_.as_or_fail_(lhs), String_.as_or_fail_(rhs));} catch (Exception e) {Err_.Noop(e); return false;}}
