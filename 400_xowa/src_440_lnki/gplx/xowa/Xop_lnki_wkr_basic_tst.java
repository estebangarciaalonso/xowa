...
public class Xop_lnki_wkr_basic_tst {
	...
	@Test  public void Image() {
		...
		fxt.Test_parse_page_wiki("[[Image:a|left]]"			, fxt.tkn_lnki_().HAlign_(Xop_lnki_halign.Left));
		fxt.Test_parse_page_wiki("[[Image:a|top]]"			, fxt.tkn_lnki_().VAlign_(Xop_lnki_valign.Top));
	...
	@Test  public void Nl_pipe_2() {	// PURPOSE: "\n|" still triggers tblw if "dangling" xnde; in this case, sole <li> automatically inserts <ul> beforehand
		fxt.Init_log_(Xop_xnde_log.Dangling_xnde).Test_parse_page_wiki("[[Image:A.png|thumb\n<li>a</li>\n|alt=test]]", fxt.tkn_lnki_()
			.Alt_tkn_(fxt.tkn_arg_nde_()
