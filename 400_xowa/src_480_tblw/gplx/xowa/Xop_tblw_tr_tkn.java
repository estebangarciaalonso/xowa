...
public class Xop_tblw_tr_tkn extends Xop_tkn_itm_base implements Xop_tblw_tkn {
	...
	public int Tag_id() {return Xop_xnde_tag_.Tid_tr;}
	...
	public Xop_tblw_tr_tkn(int bgn, int end, boolean tblw_xml) {this.tblw_xml = tblw_xml; this.Tkn_ini_pos(false, bgn, end);}
}
