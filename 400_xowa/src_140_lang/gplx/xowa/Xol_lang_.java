...
public class Xol_lang_ {
	...
	public static void Lang_init(Xol_lang lang) {
		...
		lang.Xatrs_gallery().Add_str_obj("perrow", ByteVal.new_(Xtn_gallery_nde.Xatr_id_perrow));
		lang.Xatrs_gallery().Add_str_obj("widths", ByteVal.new_(Xtn_gallery_nde.Xatr_id_widths));
		lang.Xatrs_gallery().Add_str_obj("heights", ByteVal.new_(Xtn_gallery_nde.Xatr_id_heights));
...
kwd_mgr.New(Bool_.N, Xol_kwd_grp_.Id_lst											, "#lst");
kwd_mgr.New(Bool_.N, Xol_kwd_grp_.Id_lstx											, "#lstx");
