...
class Xob_lnki_regy_tbl {
	...
	, Fld_olr_lnki_page_id = "olr_lnki_page_id";
	...
	,	", olr_lnki_page_id    integer             NOT NULL"
	,	");"
	);
	private static final String Sql_create_data = String_.Concat_lines_nl
	(	"INSERT INTO oimg_lnki_regy (olr_lnki_ttl, olr_lnki_ext, olr_lnki_type, olr_lnki_w, olr_lnki_h, olr_lnki_upright, olr_lnki_thumbtime, olr_lnki_count, olr_lnki_page_id)"
	,	"SELECT  olt_lnki_ttl"
	,	",       olt_lnki_ext"
	,	",       olt_lnki_type"
	,	",       olt_lnki_w"
