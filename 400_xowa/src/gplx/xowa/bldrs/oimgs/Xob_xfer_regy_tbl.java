...
class Xob_xfer_regy_log_tbl {
	...
	(	"CREATE TABLE IF NOT EXISTS oimg_xfer_regy_log"
	...
	public static final String Tbl_name = "oimg_xfer_regy_log"
	, Fld_oxr_lnki_id = "oxr_lnki_id", Fld_oxr_xfer_status = "oxr_xfer_status", Fld_oxr_xfer_bin_tid = "oxr_xfer_bin_tid", Fld_oxr_xfer_bin_msg = "oxr_xfer_bin_msg"
	;
}
class Xob_xfer_regy_tbl {
	...
	public static void Create_index(Gfo_usr_dlg usr_dlg, Db_provider p)	{Sqlite_engine_.Idx_create(usr_dlg, p, Xodb_db_file.Name__oimg_lnki, Idx_lnki_page_id);}
	...
	( "SELECT   *"
	, "FROM     oimg_xfer_regy"
	, "WHERE    oxr_xfer_status  =  0"
	, "AND      oxr_lnki_page_id >= ?"
	, "ORDER BY oxr_lnki_page_id, oxr_lnki_id"
	, "LIMIT    ?"
	);
	public static DataRdr Select_by_lnki_page_id(Db_provider p, int lnki_page_id, int select_interval) {
		Db_qry qry = Db_qry_.select_().Cols_all_()
			.From_(Tbl_name)
			.Where_(gplx.criterias.Criteria_.And_many(Db_crt_.eq_(Fld_oxr_xfer_status, 0), Db_crt_.mte_(Fld_oxr_lnki_page_id, lnki_page_id)))
			.OrderBy_many_(Fld_oxr_lnki_page_id, Fld_oxr_lnki_id)
			.Limit_(select_interval)
			;
		return p.Exec_qry_as_rdr(qry);
	}
	public static final String Tbl_name = "oimg_xfer_regy"
	, Fld_oxr_lnki_id = "oxr_lnki_id", Fld_oxr_lnki_page_id = "oxr_lnki_page_id", Fld_oxr_orig_page_id = "oxr_orig_page_id"
	, Fld_oxr_xfer_repo = "oxr_xfer_repo", Fld_oxr_xfer_ttl = "oxr_xfer_ttl", Fld_oxr_xfer_redirect_src = "oxr_xfer_redirect_src"
	, Fld_oxr_xfer_ext = "oxr_xfer_ext", Fld_oxr_xfer_type = "oxr_xfer_type", Fld_oxr_orig_media_type = "oxr_orig_media_type"
	...
	, "( oxr_lnki_id, oxr_lnki_page_id, oxr_orig_page_id, oxr_xfer_repo, oxr_xfer_ttl, oxr_xfer_redirect_src, oxr_xfer_ext, oxr_orig_media_type"
	, ", oxr_file_is_orig, oxr_orig_w, oxr_orig_h, oxr_file_w, oxr_file_h, oxr_xfer_thumbtime, oxr_xfer_count"
	, ", oxr_xfer_status"
	, ")"
	, "SELECT "
	, "  Min(oxt_lnki_id), Min(oxt_lnki_page_id), Min(oxt_orig_page_id), oxt_xfer_repo, oxt_xfer_ttl, Max(oxt_xfer_redirect_src), oxt_xfer_ext, oxt_orig_media_type"	// NOTE: Max(oxt_xfer_redirect_src) not Min (else would get '')
	...
	, ")"
	, "SELECT "
	, "  Min(oxt_lnki_id), Min(oxt_lnki_page_id), Min(oxt_orig_page_id), oxt_xfer_repo, oxt_xfer_ttl, Max(oxt_xfer_redirect_src), oxt_xfer_ext, oxt_orig_media_type"
