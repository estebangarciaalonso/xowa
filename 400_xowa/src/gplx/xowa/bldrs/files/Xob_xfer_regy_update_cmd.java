...
public class Xob_xfer_regy_update_cmd extends Xob_itm_basic_base implements Xob_cmd {
	...
	private void Copy_atrs_to_make_db(Db_conn make_db_provider) {
		...
		Fsm_abc_mgr fsdb_abc_mgr = wiki.File_mgr().Fsdb_mgr().Mnt_mgr().Abc_mgr_at(0);		// 0 = fsdb.main
		...
		String insert_sql_fsdb_thm = wiki.File_mgr().Fsdb_mgr().Mnt_mgr().Abc_mgr_at(0).Cfg_mgr().Schema_thm_page()	// Cfg_get(Fsm_cfg_mgr.Grp_core).Get_yn_or_n(Fsm_cfg_mgr.Key_schema_thm_page)
