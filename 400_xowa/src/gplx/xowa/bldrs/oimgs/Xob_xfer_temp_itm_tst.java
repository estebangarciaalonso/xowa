...
public class Xob_xfer_temp_itm_tst {
	...
	@Test   public void Missing_orig()		{fxt.Test_fail(Xob_xfer_temp_itm.Chk_tid_orig_page_id_is_null		, KeyVal_.new_(Xob_orig_regy_tbl.Fld_oor_orig_page_id, null));}
	@Test   public void File_is_audio()		{fxt.Test_fail(Xob_xfer_temp_itm.Chk_tid_orig_media_type_is_audio	, KeyVal_.new_(Xob_orig_regy_tbl.Fld_oor_orig_media_type, Xof_media_type.Name_audio));}
	@Test   public void File_is_midi()		{fxt.Test_fail(Xob_xfer_temp_itm.Chk_tid_orig_media_type_is_audio	, KeyVal_.new_(Xob_lnki_regy_tbl.Fld_olr_lnki_ext, Xof_ext_.Id_mid));}
	@Test   public void Ogg_to_ogv() {
		fxt.Test_bgn
		(	KeyVal_.new_(Xob_lnki_regy_tbl.Fld_olr_lnki_ext			, Xof_ext_.Id_ogg)
		,	KeyVal_.new_(Xob_orig_regy_tbl.Fld_oor_orig_media_type	, Xof_media_type.Name_video)
		);
	...
	@Test   public void Redirect_src_is_empty() {	// orig_cmd sets all direct files to have "orig_join" == "lnki_ttl"
		fxt.Test_bgn
		(	KeyVal_.new_(Xob_orig_regy_tbl.Fld_oor_orig_join_ttl	, "A.png")
		,	KeyVal_.new_(Xob_orig_regy_tbl.Fld_oor_lnki_ttl			, "A.png")
		);
	...
	@Test   public void Redirect_src_has_val() {	// orig_cmd sets all redirect files to have "orig_join" = redirect and "lnki_ttl" as orig; EX: A.png redirects to B.png; orig_join will be B.png (the actual image) and redirect_src will be A.png (the original lnki)
		fxt.Test_bgn
		(	KeyVal_.new_(Xob_orig_regy_tbl.Fld_oor_orig_join_ttl	, "B.png")
		,	KeyVal_.new_(Xob_orig_regy_tbl.Fld_oor_lnki_ttl			, "A.png")
		);
	...
	@Test   public void Redirect_should_take_trg_ext() {// if "A.png" redirects to "B.jpg", ext_id should be ".jpg" (the actual file) not ".png (lnki_ext_id)
		fxt.Test_bgn
		(	KeyVal_.new_(Xob_orig_regy_tbl.Fld_oor_orig_join_ttl	, "B.jpg")
		,	KeyVal_.new_(Xob_orig_regy_tbl.Fld_oor_lnki_ttl			, "A.png")
		,	KeyVal_.new_(Xob_lnki_regy_tbl.Fld_olr_lnki_ext			, Xof_ext_.Id_png)	// .png b/c A.png
		);
	...
	@Test   public void Thumbtime_should_only_apply_to_video() {// PURPOSE: one image actually had a thumbtime defined; EX: General_Dynamics_F-16_Fighting_Falcon; [[File:Crash.arp.600pix.jpg|thumb|thumbtime=2]]
		fxt.Test_bgn
		(	KeyVal_.new_(Xob_lnki_regy_tbl.Fld_olr_lnki_thumbtime, (double)3)	// define thumbtime; note that file is image
		);
...
class Xob_xfer_temp_itm_fxt {
	...
	{ Xob_lnki_regy_tbl.Fld_olr_lnki_ext
	, Xob_orig_regy_tbl.Fld_oor_orig_media_type
	, Xob_lnki_regy_tbl.Fld_olr_lnki_id
	, Xob_orig_regy_tbl.Fld_oor_orig_repo
	, Xob_orig_regy_tbl.Fld_oor_orig_join_ttl
	, Xob_orig_regy_tbl.Fld_oor_lnki_ttl
	, Xob_lnki_regy_tbl.Fld_olr_lnki_type
	, Xob_lnki_regy_tbl.Fld_olr_lnki_w
	, Xob_lnki_regy_tbl.Fld_olr_lnki_h
	, Xob_lnki_regy_tbl.Fld_olr_lnki_count
	, Xob_lnki_regy_tbl.Fld_olr_lnki_page_id
	, Xob_orig_regy_tbl.Fld_oor_orig_w
	, Xob_orig_regy_tbl.Fld_oor_orig_h
	, Xob_orig_regy_tbl.Fld_oor_orig_page_id
	, Xob_lnki_regy_tbl.Fld_olr_lnki_upright
	, Xob_lnki_regy_tbl.Fld_olr_lnki_thumbtime
	}
	;
	public void Reset() {
		itm.Clear();
