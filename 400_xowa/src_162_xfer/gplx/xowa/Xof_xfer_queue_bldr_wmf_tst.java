...
//		// Test: Thumb_height only specified	"[[File:A.png|thumb|x50px]]").Src_xfer_("200,100", "mem/wiki/c0/7/70/A.png" -> 100,50
	...
	@Test  public void Upright() {	// PURPOSE: upright can generate thumb that is larger than orig; thumb is not on wmf, so orig must be used EX.WP:Saint Petersburg [[File:Georgyj Poltavchenko.jpeg|thumb]]
...
//				,	fxt.img_("mem/trg/commons.wikimedia.org/fit/7/70/A.png/130px.png", 130, 163)	// FUTURE: should delete these since they are not used
			,	fxt.reg_("mem/xowa/file/#meta/en.wikipedia.org/7/70.csv", "A.png|0||1?148,186|1?130,163"
				)
			)
		.tst();
		fxt.tst_html_src("file:///mem/trg/commons.wikimedia.org/raw/7/0/A.png");
	}
