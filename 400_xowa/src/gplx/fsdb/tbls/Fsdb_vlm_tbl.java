...
public class Fsdb_vlm_tbl {
	...
	public Fsdb_vlm_data[] Select_all(Db_provider p, Io_url dir) {
...
//					String url = rdr.ReadStr(Fld_vlm_url);
				...
				Fsdb_vlm_data itm = new Fsdb_vlm_data().Init(null, id, key, path_bgn);
				rv.Add(itm);
				++id;
			}
		} finally {rdr.Rls();}
		return (Fsdb_vlm_data[])rv.XtoAry(Fsdb_vlm_data.class);
	}
