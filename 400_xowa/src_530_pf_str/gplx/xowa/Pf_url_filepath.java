...
class Pf_url_filepath extends Pf_func_base {
	...
	@Override public void Func_evaluate(Xop_ctx ctx, byte[] src, Xot_invk caller, Xot_invk self, ByteAryBfr bb) {
		...
		byte[] url = url_bldr.Set_trg_html_(Xof_repo_itm.Mode_orig, trg_repo, ttl_bry, xfer_itm.Lnki_md5(), xfer_itm.Lnki_ext(), Xof_url_.Null_size_deprecated, Xop_lnki_tkn.Thumbtime_null).Xto_bry();
		bb.Add(url);
