...
class Ref_itm_mgr_fxt {
	...
	public Ref_itm_mgr_fxt run_Add_follow(String follow)		{return run_Add_grp(ByteAry_.Empty, ByteAry_.new_utf8_(follow), ByteAry_.Ary(ByteAry_.Empty));}
	public Ref_itm_mgr_fxt run_Add(String... name_ary)	{return run_Add_grp(ByteAry_.Empty, ByteAry_.Empty, ByteAry_.Ary(name_ary));}
	public Ref_itm_mgr_fxt run_Add_grp(String grp, String... name_ary) {return run_Add_grp(ByteAry_.new_utf8_(grp), ByteAry_.Empty, ByteAry_.Ary(name_ary));}
	...
	public Ref_itm_mgr_fxt tst(Xtn_ref_nde_chkr... chkr_ary) {return tst_grp(ref_mgr.Lst_get(ByteAry_.Empty, 0), chkr_ary);}
	public Ref_itm_mgr_fxt tst_grp(String grp_name, Xtn_ref_nde_chkr... chkr_ary) {return tst_grp(ref_mgr.Lst_get(ByteAry_.new_ascii_(grp_name), 0), chkr_ary);}
