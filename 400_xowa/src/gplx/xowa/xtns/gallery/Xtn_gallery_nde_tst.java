...
public class Xtn_gallery_nde_tst {
	...
	@Before public void init() {fxt.Reset(); fxt.Wiki().Xtn_mgr().Xtn_gallery().Parser().Init_by_wiki(fxt.Wiki());}
...
class Xtn_gallery_mgr_data_chkr implements Tst_chkr {
	...
	public Xtn_gallery_itm_chkr[] Expd_subs() {return expd_subs;} public Xtn_gallery_mgr_data_chkr Expd_subs_(Xtn_gallery_itm_chkr... v) {expd_subs = v; return this;} Xtn_gallery_itm_chkr[] expd_subs = null;
	...
	public int Chk_subs(Tst_mgr mgr, String path, Xtn_gallery_nde actl, int err) {
		if (expd_subs != null) {
			...
			Xtn_gallery_itm[] actl_subs = new Xtn_gallery_itm[actl_subs_len];  
...
class Xtn_gallery_itm_chkr implements Tst_chkr {
	public Class<?> TypeOf() {return Xtn_gallery_itm.class;}
	public Xtn_gallery_itm_chkr Expd_lnki_(String v)	{expd_lnki = Xoa_ttl_chkr.new_(v); return this;} private Xoa_ttl_chkr expd_lnki;
	public Xtn_gallery_itm_chkr Expd_caption_(String v) {expd_caption = v; return this;} private String expd_caption;
	public int Chk(Tst_mgr mgr, String path, Object actl_obj) {
		Xtn_gallery_itm actl = (Xtn_gallery_itm)actl_obj;
		int err = 0;
