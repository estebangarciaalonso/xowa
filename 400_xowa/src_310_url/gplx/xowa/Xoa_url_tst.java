...
class Xoa_url_fxt {
	public void Clear() {}
	public Xoa_url url_(String wiki_str, String page_str, boolean redirect_force) {return new Xoa_url().Wiki_bry_(ByteAry_.new_utf8_(wiki_str)).Page_bry_(ByteAry_.new_utf8_(page_str)).Redirect_force_(redirect_force);}
