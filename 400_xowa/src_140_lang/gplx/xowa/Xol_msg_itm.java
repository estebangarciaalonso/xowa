...
public class Xol_msg_itm {
	...
	public boolean Search_mediawiki() {return search_mediawiki;} public Xol_msg_itm Search_mediawiki_(boolean v) {search_mediawiki = v; return this;} private boolean search_mediawiki = true;
	...
	public byte[] Fmt(ByteAryBfr bfr, Object... args) {
		tmp_fmtr.Fmt_(val);
		tmp_fmtr.Bld_bfr_many(bfr, args);
		return bfr.XtoAryAndClear();
	}	static ByteAryFmtr tmp_fmtr = ByteAryFmtr.tmp_();
	public byte[] Fmt_tmp(ByteAryBfr bfr, byte[] tmp_val, Object... args) {
		tmp_fmtr.Fmt_(tmp_val);
		tmp_fmtr.Bld_bfr_many(bfr, args);
		return bfr.XtoAryAndClear();
	}
	public static final byte Src_null = 0, Src_lang = 1, Src_wiki = 2, Src_unknown = 3;
}
