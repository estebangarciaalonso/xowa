...
import org.junit.*;
public class Scrib_lua_regx_converter_tst {
	@Before public void init() {fxt.Clear();} Scrib_lua_regx_converter_fxt fxt = new Scrib_lua_regx_converter_fxt();
...
class Scrib_lua_regx_converter_fxt {
	public void Clear() {
		if (under == null) {
			under = new Scrib_lua_regx_converter();
		}
	}	Scrib_lua_regx_converter under;
	public Scrib_lua_regx_converter_fxt Init_no_anchor_(boolean v) {init_no_anchor = v; return this;} private boolean init_no_anchor;
