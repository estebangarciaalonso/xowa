...
class Arg_itm_tkn_null extends Xop_tkn_null implements Arg_itm_tkn {	public int Dat_bgn() {return -1;}
	...
	public byte[] Dat_ary() {return ByteAry_.Empty;} public Arg_itm_tkn Dat_ary_(byte[] dat_ary) {return this;}
	public byte[] Dat_to_bry(byte[] src) {return ByteAry_.Empty;}
...
class Arg_itm_tkn_base extends Xop_tkn_itm_base implements Arg_itm_tkn {
	...
	public byte[] Dat_to_bry(byte[] src) {return ByteAry_.Len_eq_0(dat_ary) ? ByteAry_.Mid(src, dat_bgn, dat_end) : dat_ary;}
	public byte[] Dat_ary() {return dat_ary;} private byte[] dat_ary = ByteAry_.Empty;
	...
	public Arg_itm_tkn Dat_rng_ary_(byte[] src, int bgn, int end) {
		...
		dat_ary = ByteAry_.Mid(src, bgn, end);
		return this;
	}
