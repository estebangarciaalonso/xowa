...
public class Xoa_hive_mgr {
	...
	}	private Xowd_regy_mgr regy_mgr = new Xowd_regy_mgr(); IntRef bry_len = IntRef.zero_(); Xob_xdat_file xdat_rdr = new Xob_xdat_file(); Xob_xdat_itm xdat_itm = new Xob_xdat_itm();
