...
class Xob_xfer_temp_tbl {
	...
	public static Db_stmt Insert_stmt(Db_provider p) {return Db_stmt_.new_insert_(p, Tbl_name, Fld_oxt_lnki_id, Fld_oxt_xfer_repo, Fld_oxt_orig_page_id, Fld_oxt_xfer_ttl, Fld_oxt_xfer_ext, Fld_oxt_xfer_type, Fld_oxt_orig_media_type, Fld_oxt_file_is_orig, Fld_oxt_file_w, Fld_oxt_html_w, Fld_oxt_html_h, Fld_oxt_xfer_thumbtime, Fld_oxt_xfer_count);}
	public static void Insert(Db_stmt stmt, int lnki_id, byte repo_id, int page_id, String ttl, int ext_id, byte lnki_type, String orig_media_type, boolean file_is_orig, int file_w, int html_w, int html_h, double thumbtime, int count) {
		stmt.Clear()
		.Val_int_(lnki_id)
		.Val_byte_(repo_id)
		.Val_int_(page_id)
	...
	, Fld_oxt_file_is_orig = "oxt_file_is_orig", Fld_oxt_file_w = "oxt_file_w", Fld_oxt_html_w = "oxt_html_w", Fld_oxt_html_h = "oxt_html_h", Fld_oxt_xfer_thumbtime = "oxt_xfer_thumbtime"
