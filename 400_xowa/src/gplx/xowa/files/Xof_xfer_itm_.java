...
public class Xof_xfer_itm_ {
	...
	public static void Calc_view(Int_2_ref rv, int lnki_w, int lnki_h, int file_w, int file_h, boolean thumb_width_must_be_lt_file_width) {// SEE:NOTE_1 for proc source/layout
