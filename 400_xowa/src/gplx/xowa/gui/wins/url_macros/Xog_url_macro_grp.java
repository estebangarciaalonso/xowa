...
public class Xog_url_macro_grp implements GfoInvkAble {
	...
	public void Set(String abrv, String fmt) {Set(ByteAry_.new_utf8_(abrv), ByteAry_.new_utf8_(fmt));}
...
class Xog_url_macro_itm {
	...
	public byte[] Fmtr_exec(ByteAryBfr bfr, Object... args) {
		if (fmtr == null) fmtr = new ByteAryFmtr().Fmt_(fmt).Compile();
