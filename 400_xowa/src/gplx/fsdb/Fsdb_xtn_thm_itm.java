...
public class Fsdb_xtn_thm_itm {
	public Fsdb_xtn_thm_itm(int id, int owner, int w, int thumbtime, boolean is_orig, int h, long size, String modified, String sha1) {
	...
	public boolean Is_orig() {return is_orig;} public Fsdb_xtn_thm_itm Is_orig_(boolean v) {is_orig = v; return this;} private boolean is_orig;
	...
	public static Fsdb_xtn_thm_itm new_() {return new Fsdb_xtn_thm_itm(0, 0, 0, 0, false, 0, 0, "", "");}
        public static final Fsdb_xtn_thm_itm Null = new Fsdb_xtn_thm_itm(0, 0, 0, 0, false, 0, 0, "", "");
