...
public class Xof_url_tst {
	Xof_url_fxt fxt = new Xof_url_fxt();
...
class Xof_url_fxt {
	public Xof_url_fxt ini() {lnki_img_type = Xop_lnki_type.Id_thumb; lnki_upright = -1; file_w = file_h = lnki_w = lnki_h = -1; return this;}
	public Xof_url_fxt Lnki_img_type_(byte v) {lnki_img_type = v; return this;} private byte lnki_img_type;
	public Xof_url_fxt Lnki_upright_(double v) {lnki_upright = v; return this;} double lnki_upright;
	public Xof_url_fxt File_(int w, int h) {file_w = w; file_h = h; return this;} private int file_w, file_h;
	public Xof_url_fxt Lnki_(int w, int h) {lnki_w = w; lnki_h = h; return this;} private int lnki_w, lnki_h;
	public Xof_url_fxt tst(int expd_w, int expd_h) {
		boolean wmf_thumbable = Xof_xfer_itm.Lnki_thumbable_calc(lnki_img_type, lnki_w, lnki_h);
		Int_2_ref calc_size = new Int_2_ref();
		Xof_xfer_itm_.Calc_xfer_size(calc_size, Xof_img_mgr.Thumb_w_img_const, file_w, file_h, lnki_w, lnki_h, wmf_thumbable, lnki_upright);
