...
public class Gallery_nde implements Xop_xnde_xtn, Xop_xnde_atr_parser {
	...
	public void Xtn_compile(Xow_wiki wiki, Xop_ctx ctx, Xop_tkn_mkr tkn_mkr, Xop_root_tkn root, byte[] src, Xop_xnde_tkn xnde) {
		...
		wiki.Xtn_mgr().Gallery().Parser().Parse_all(itms, src, xnde.Tag_open_end(), xnde.Tag_close_bgn(), itm_w, itm_h);
