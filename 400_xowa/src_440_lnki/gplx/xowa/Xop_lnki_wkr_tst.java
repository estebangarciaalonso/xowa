...
public class Xop_lnki_wkr_tst {
	...
	@Test  public void Image() {
		fxt.tst_Parse_page_wiki("[[Image:a]]"				, fxt.tkn_lnki_().NmsId_(Xow_ns_.Id_file).Trg_tkn_(fxt.tkn_arg_val_(fxt.tkn_txt_(2, 7), fxt.tkn_colon_(7), fxt.tkn_txt_(8, 9))));
		...
		fxt.tst_Parse_page_wiki("[[Image:a|thumb|alt=b|c d]]"
			, fxt.tkn_lnki_().NmsId_(Xow_ns_.Id_file)
	...
	@Test  public void Outliers() {
		fxt.tst_Parse_page_wiki("[[Image:a=b.svg|thumb|10px]]", fxt.tkn_lnki_().NmsId_(Xow_ns_.Id_file).Trg_tkn_(fxt.tkn_arg_nde_().Val_tkn_(fxt.tkn_arg_itm_(fxt.tkn_txt_(2, 7), fxt.tkn_colon_(7), fxt.tkn_txt_(8, 9), fxt.tkn_eq_(9), fxt.tkn_txt_(10, 15)))));
		fxt.tst_Parse_page_wiki("[[Category:a|b]]", fxt.tkn_lnki_().NmsId_(Xow_ns_.Id_category));
	}
	@Test  public void Exc_caption_has_eq() {
		fxt.tst_Parse_page_wiki("[[Image:a.svg|thumb|a=b]]", fxt.tkn_lnki_().NmsId_(Xow_ns_.Id_file)
