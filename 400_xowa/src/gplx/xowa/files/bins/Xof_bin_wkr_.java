...
public class Xof_bin_wkr_ {
	...
	public static final byte Tid_null = Byte_.MaxValue_127, Tid_noop = 1, Tid_not_found = 2, Tid_fsdb_wiki = 3, Tid_fsdb_regy = 4, Tid_http_wmf = 5, Tid_fsys_wmf = 6, Tid_fsys_xowa = 7, Tid_fsys_dir = 8;
