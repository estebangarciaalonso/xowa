...
public class Xoa_app_ {
	...
	public static final String Version = "0.11.3.0";
...
class Xoa_app_boot_mgr {
	private Gfo_usr_dlg_xowa usr_dlg; private Gfo_log_wtr log_wtr; private String chkpoint = "null";
	...
	private void Run_app(App_cmd_mgr args_mgr) {
		...
		try {
			...
			// init app
			app = new Xoa_app(usr_dlg, root_dir, user_dir, Xoa_app_.Op_sys); usr_dlg.Log_wtr().Queue_enabled_(false); log_wtr.Log_msg_to_session_fmt("app_new");
