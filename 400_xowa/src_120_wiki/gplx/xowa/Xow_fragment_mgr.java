...
public class Xow_fragment_mgr implements GfoInvkAble {
	...
	public void Evt_lang_changed(Xol_lang lang) {
		ByteAryBfr bfr = lang.App().Utl_bry_bfr_mkr().Get_b512();
		...
		byte[] num_format_separators = Html_js_table_num_format_separators(bfr, lang.Num_fmt_mgr());
	...
	byte[] Html_js_table_months(ByteAryBfr bfr, Xow_msg_mgr msg_mgr, int january_id, int december_id) {
