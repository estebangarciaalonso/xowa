...
public class Fsdb_db_atr_mgr implements RlsAble {
	...
	public int Img_insert(Fsdb_xtn_img_itm rv, String dir, String fil, int ext_id, DateAdp modified, String hash, long bin_len, gplx.ios.Io_stream_rdr bin_rdr, int img_w, int img_h, int db_data_id) {
		return itms_0.Img_insert(rv, dir, fil, ext_id, modified, hash, bin_len, bin_rdr, img_w, img_h, db_data_id);
	}
