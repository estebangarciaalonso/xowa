...
public class Xob_lnki_regy_cmd extends Xob_itm_basic_base implements Xob_cmd {
	public Xob_lnki_regy_cmd(Xob_bldr bldr, Xow_wiki wiki) {this.Cmd_init(bldr, wiki);}
	public String Cmd_key() {return KEY_oimg;} public static final String KEY_oimg = "oimg.lnki_regy";
	public void Cmd_ini(Xob_bldr bldr) {}
	public void Cmd_bgn(Xob_bldr bldr) {
		Db_provider provider = Xodb_db_file.init__oimg_lnki(wiki).Provider();
		Xob_lnki_regy_tbl.Create_table(provider);
		Xob_lnki_regy_tbl.Create_data(usr_dlg, provider);
	}
	public void Cmd_run() {}
	public void Cmd_end() {}
