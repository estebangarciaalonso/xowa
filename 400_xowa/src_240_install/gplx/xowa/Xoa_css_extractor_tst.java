...
public class Xoa_css_extractor_tst {
...
class Xoa_css_extractor_fxt {
	public void Clear() {
		...
		css_installer
			.Usr_dlg_(usr_dlg)
			.Wiki_domain_(ByteAry_.new_ascii_("en.wikipedia.org"))
		...
		css_img_downloader.Ctor(usr_dlg, new Xof_download_wkr_test(), ByteAry_.new_ascii_("mem/http/"));
	...
	public void Init_page(int ns_id, String ttl, String text) {
		page_fetcher.Add(ns_id, ByteAry_.new_ascii_(ttl), ByteAry_.new_ascii_(text));
	}
