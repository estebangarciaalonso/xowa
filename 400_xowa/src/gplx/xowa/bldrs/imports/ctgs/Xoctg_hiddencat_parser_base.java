...
public abstract class Xoctg_hiddencat_parser_base extends Xob_sql_dump_base implements Sql_file_parser_cmd {
	public Xoctg_hiddencat_parser_base Ctor(Xob_bldr bldr, Xow_wiki wiki) {this.Cmd_init(bldr, wiki); this.make_fil_len = Io_mgr.Len_mb; return this;}
	...
	public void Exec(byte[] src, byte[] fld_key, int fld_idx, int fld_bgn, int fld_end, ByteAryBfr file_bfr, Sql_file_parser_data data) {
		switch (fld_idx) {
			case Fld_id:			cur_id = ByteAry_.XtoIntByPos(src, fld_bgn, fld_end, -1); break;
