...
class Pf_xtn_iferror extends Pf_func_base {
	...
	@Override public Pf_func New(int id, byte[] name) {return new Pf_xtn_iferror().Name_(name);}
	...
	private static ByteTrieMgr_slim trie_() {
		ByteTrieMgr_slim rv = ByteTrieMgr_slim.ci_();
	...
	private static void trie_init(ByteTrieMgr_slim trie, byte b, String s) {trie.Add(s, ByteVal.new_(b));}
}
