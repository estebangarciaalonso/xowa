...
public class Xobc_math_run extends Xob_itm_basic_base implements Xob_cmd, GfoInvkAble {
	...
	public void Cmd_bgn(Xob_bldr bldr) {
		...
		dump_bfr = new ByteAryBfr(dump_fil_len); fld_wtr = Gfo_fld_wtr.xowa_().Bfr_(dump_bfr); 
	...
	ByteAryBfr dump_bfr = ByteAryBfr.new_(); Gfo_fld_wtr fld_wtr; Gfo_fld_rdr fld_rdr, lnk_parser; ByteAryBfr tmp = ByteAryBfr.new_();
