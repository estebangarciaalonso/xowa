...
public class Bry_comparer_fld_last implements gplx.lists.ComparerAble {
	public int compare(Object lhsObj, Object rhsObj) {
		...
		int lhs_bgn = ByteAry_.FindBwd(lhs, Byte_ascii.Pipe); if (lhs_bgn == ByteAry_.NotFound) lhs_bgn = -1;
		int rhs_bgn = ByteAry_.FindBwd(rhs, Byte_ascii.Pipe); if (rhs_bgn == ByteAry_.NotFound) rhs_bgn = -1;
