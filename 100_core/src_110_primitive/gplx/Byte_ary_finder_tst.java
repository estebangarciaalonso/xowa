...
import org.junit.*;
import gplx.texts.*;
public class Byte_ary_finder_tst {
	...
	}	void tst_Find_fwd(String src, String lkp, int bgn, int expd) {Tfds.Eq(expd, Byte_ary_finder.Find_fwd(ByteAry_.new_utf8_(src), ByteAry_.new_utf8_(lkp), bgn));}
	...
	}	void tst_Find_bwd(String src, String lkp, int bgn, int expd) {Tfds.Eq(expd, Byte_ary_finder.Find_bwd(ByteAry_.new_utf8_(src), ByteAry_.new_utf8_(lkp), bgn));}
	@Test  public void Find_bwd_last_ws() {
		Find_bwd_1st_ws_tst("a b"		, 2, 1);					// basic
		Find_bwd_1st_ws_tst("a   b"		, 3, 1);					// multiple
		Find_bwd_1st_ws_tst("ab"			, 1, ByteAry_.NotFound);	// none
	}
	void Find_bwd_1st_ws_tst(String src, int pos, int expd) {Tfds.Eq(expd, Byte_ary_finder.Find_bwd_last_ws(ByteAry_.new_ascii_(src), pos));}
}
