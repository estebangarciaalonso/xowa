...
//		private OrderedHash[] retrieve_lists;  
...
//		public void Thm_select(Xof_fsdb_itm[] ary) {
//			int len = ary.length;
//			Thm_select__find_vlm(retrieve_lists, ary, len);
//			Thm_select__load_bin(retrieve_lists, vlms_len);
//		}
//		private void Thm_select__find_vlm(OrderedHash[] retrieve_lists, Xof_fsdb_itm[] ary, int len) {
//			Array_.Sort(ary, Xof_fsdb_itm_comparer_ttl._); // sort ary by name;
...
//					Thm_select__find_vlm_nxt(tmp_pos, tmp_ttl, vlms, vlms_len, cur_db_id, cur_ttl);
...
//			}		
//		}
//		private void Thm_select__find_vlm_nxt(IntRef nxt_pos, ByteAryRef nxt_bry, Fsdb_vlm_db_data[] vlms, int vlms_len, int cur_pos, byte[] cur_ttl) {
...
//			nxt_bry.Val_(null);
//		}
//		private void Thm_select__load_bin(OrderedHash[] retrieve_lists, int len) {
//			for (int i = 0; i < len; i++) {
