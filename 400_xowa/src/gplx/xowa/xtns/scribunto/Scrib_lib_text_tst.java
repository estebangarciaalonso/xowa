...
public class Scrib_lib_text_tst {
	...
	@Test  public void GetEntityTable() {
		...
		rv = ByteAry_.Replace(rv, new byte[] {Byte_ascii.Semic, Byte_ascii.Semic}, new byte[] {Byte_ascii.Semic});
		Tfds.Eq(1510, ByteAry_.Split(rv, Byte_ascii.Semic).length);
	}
}	
