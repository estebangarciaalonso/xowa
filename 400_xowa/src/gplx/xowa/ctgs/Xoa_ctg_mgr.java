...
public class Xoa_ctg_mgr implements GfoInvkAble {
	...
	public Object Invk(GfsCtx ctx, int ikey, String k, GfoMsg m) {
		...
		else if	(ctx.Match(k, Invk_pagecats_grouping_enabled))		return Yn.XtoStr(pagecats_grouping_enabled);
	...
	private static final byte[] Missing_ctg_cls_normal_css = ByteAry_.new_ascii_(".xowa-missing-category-entry {}\n"), Missing_ctg_cls_hide_css = ByteAry_.new_ascii_(".xowa-missing-category-entry {display: none;}\n"), Missing_ctg_cls_red_css = ByteAry_.new_ascii_(".xowa-missing-category-entry {color: red;}\n");
