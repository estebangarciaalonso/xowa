...
class Xob_xfer_temp_tbl {
	...
	public static void Insert(Db_stmt stmt, int lnki_id, byte repo_id, int page_id, String ttl, String redirect_src, int ext_id, byte lnki_type, String orig_media_type, boolean file_is_orig, int orig_w, int orig_h, int html_w, int html_h, int file_w, int file_h, double thumbtime, int count) {
		stmt.Clear()
		.Val_int_(lnki_id)
		.Val_byte_(repo_id)
		.Val_int_(page_id)
