...
public class Xof_fsdb_itm {
	...
	public boolean			Lnki_type_is_thumb() {return lnki_type_is_thumb;} private boolean lnki_type_is_thumb;
	...
	public Xof_fsdb_itm	Init_by_lnki(byte[] lnki_ttl, Xof_ext ext, byte[] md5, byte lnki_type, int lnki_w, int lnki_h, double lnki_upright, int lnki_thumbtime) {			
		this.lnki_ttl = lnki_ttl; this.lnki_ext = ext; this.lnki_md5 = md5; this.lnki_type = lnki_type;
		this.lnki_w = lnki_w; this.lnki_h = lnki_h; this.lnki_upright = lnki_upright; this.lnki_thumbtime = lnki_thumbtime;
		this.lnki_type_is_thumb = Xop_lnki_type.Id_is_thumb_like(lnki_type); this.lnki_type_as_mode = lnki_type_is_thumb ? Xof_repo_itm.Mode_thumb : Xof_repo_itm.Mode_orig;
		this.orig_page = lnki_ttl;
		return this;
	}
	...
	public byte[] Orig_page() {return orig_page;} public Xof_fsdb_itm Orig_page_(byte[] v) {orig_page = v; return this;} private byte[] orig_page;
	...
	public void Html_size_calc(Int_2_ref rslt, byte exec_tid) {
		Xof_xfer_itm_.Calc_xfer_size(rslt, Xof_img_mgr.Thumb_w_img_const, orig_w, orig_h, lnki_w, lnki_h, lnki_type_is_thumb, lnki_upright, lnki_ext, exec_tid);
		html_w = rslt.Val_0(); html_h = rslt.Val_1();
	}
