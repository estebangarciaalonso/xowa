...
public abstract class Xoapi_orig_base {
	public boolean Api_query_size(Xoapi_orig_rslts rv, Xow_wiki wiki, byte[] ttl, int width, int height) {
	...
	public abstract boolean Api_query_size_exec(Xoapi_orig_rslts rv, Xow_wiki wiki, byte[] ttl, int width, int height, Gfo_usr_dlg usr_dlg, byte[] repo_wiki_key);
}
