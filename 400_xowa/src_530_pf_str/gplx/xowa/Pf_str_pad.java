...
class Pf_str_pad extends Pf_func_base {
	@Override public void Func_evaluate(Xop_ctx ctx, byte[] src, Xot_invk caller, Xot_invk self, ByteAryBfr bfr) {// REF.MW: CoreParserFunctions.php|pad
	...
	boolean pad_dir_right; static final byte[] Ary_pad_dflt = ByteAry_.new_ascii_("0");
