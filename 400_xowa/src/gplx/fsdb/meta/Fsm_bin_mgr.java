...
public class Fsm_bin_mgr implements RlsAble {
	...
	public Fsm_bin_mgr(Io_url dir) {this.dir = dir;}
	...
	public Fsm_bin_mgr Conn_by_load(Db_conn conn, Io_url dir) {
		int db_id = 0; boolean version_is_1 = Bool_.Y;
		tbl.Conn_(conn, db_id, version_is_1);
		this.fil_ary = tbl.Select_all(dir);
		this.fil_ary_len = this.fil_ary.length;
		this.fil_cur = this.fil_ary[fil_ary_len - 1];
		return this;
	}
	public Fsm_bin_mgr Conn_by_make(Db_conn conn, Io_url dir) {
		int db_id = 0; boolean version_is_1 = Bool_.Y;
		tbl.Conn_(conn, db_id, version_is_1);
		tbl.Create_table();
		this.Itms_add(0);
