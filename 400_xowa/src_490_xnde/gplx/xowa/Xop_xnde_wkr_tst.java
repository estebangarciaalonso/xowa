...
public class Xop_xnde_wkr_tst {
	...
	@Test  public void Escape_lt() {	// PURPOSE: some templates have unknown tags; EX.WP:PHP
		...
		fxt.tst_Parse_page_wiki_str("a<code><?</code>b", String_.Concat_lines_nl_skipLast
			(	"<p>a<code>&lt;?</code>b"
			,	"</p>"
			,	""
			));
	...
	@Test  public void Inline() {
		fxt.tst_Parse_page_wiki("<ref/>"	, fxt.tkn_xnde_(0, 6).CloseMode_(Xop_xnde_tkn.CloseMode_inline).Name_rng_(1, 4));
	}
	@Test  public void Pair() {
		fxt.tst_Parse_page_wiki("<div></div>", fxt.tkn_xnde_(0, 11).CloseMode_(Xop_xnde_tkn.CloseMode_pair).Name_rng_(1, 4));
	}
	@Test  public void Pair_text() {
		fxt.tst_Parse_page_wiki("<div>b</div>", fxt.tkn_xnde_(0, 12).Subs_(fxt.tkn_txt_(5, 6)));
	}
	@Test  public void Deep1_pair1() {
		fxt.tst_Parse_page_wiki("<div><div></div></div>", fxt.tkn_xnde_(0, 22).Name_rng_(1, 4)
			.Subs_(fxt.tkn_xnde_(5, 16).Name_rng_(6, 9)));
	}
	@Test  public void Deep1_inline1() {
		fxt.tst_Parse_page_wiki("<div><ref/></div>", fxt.tkn_xnde_(0, 17).Name_rng_(1, 4)
			.Subs_(fxt.tkn_xnde_(5, 11).Name_rng_(6, 9)) );
	}
	@Test  public void Deep1_pair2() {
		fxt.tst_Parse_page_wiki("<div><div></div><div></div></div>", fxt.tkn_xnde_(0, 33).Name_rng_(1, 4)
			.Subs_
	...
	@Test  public void Atrs_inline() {
		fxt.tst_Parse_page_wiki("<ref cd=\"ef\" />"		, fxt.tkn_xnde_(0, 15).Atrs_rng_(5, 13));
		fxt.tst_Parse_page_wiki("<ref   cd = \"e f\"  />"	, fxt.tkn_xnde_(0, 21).Atrs_rng_(5, 19)); // ws
	}
	@Test  public void Atrs_bgn() {
		fxt.tst_Parse_page_wiki("<div cd=\"ef\"></div>"	, fxt.tkn_xnde_(0, 19).Atrs_rng_(5, 12)); // basic
	}
	@Test  public void Errs() {
		fxt.tst_Parse_page_wiki("<", fxt.tkn_txt_(0, 1));
	}
	...
	@Test  public void Escaped() {
		fxt.ini_Log_(Xop_xnde_log.Escaped_xnde).tst_Parse_page_wiki("<div></span></div>", fxt.tkn_xnde_(0, 18).Subs_(fxt.tkn_ignore_(5, 12, Xop_ignore_tkn.Ignore_tid_xnde_dangling)));
	}
	@Test  public void Nest() {// REVISIT: 2nd <b> should be converted to </b>; other </b> ignored; WHEN: with example
		fxt.ini_Log_(Xop_xnde_log.Invalid_nest, Xop_xnde_log.Escaped_xnde).tst_Parse_page_wiki("a<b>b<b>c</b>d</b>e"
			, fxt.tkn_txt_	( 0,  1)
	...
	@Test  public void Xtn() {
		fxt.tst_Parse_page_wiki("<math><div></math>", fxt.tkn_xnde_(0, 18).Subs_(fxt.tkn_txt_(6, 11)));	// NOTE: no dangling nde b/c .Xtn skips
	}
	@Test  public void Xtn_ref() {
		fxt.tst_Parse_page_wiki("<ref name=\"a\">b</ref>", fxt.tkn_xnde_(0, 21).Name_rng_(1, 4).Atrs_rng_(5, 13).Subs_(fxt.tkn_txt_(14, 15)));
	}
	...
	@Test   public void CaseSensitivity_xtn() {	// PURPOSE: xtn end_tag may not match bgn_tag; EX: w:Ehrenfest_paradox; <References></references>
		fxt.tst_Parse_page_all_str("a<ref name=b /><References><ref name=b>c</ref></references>", String_.Concat_lines_nl
	...
	@Test  public void Br_bgn_does_not_dangle() {
		fxt.tst_Parse_page_wiki("<br>a"	, fxt.tkn_xnde_(0, 4), fxt.tkn_txt_(4, 5));
		fxt.tst_Parse_page_wiki("a<br name=b>c", fxt.tkn_txt_(0, 1), fxt.tkn_xnde_(1, 12), fxt.tkn_txt_(12, 13));
	}
	@Test  public void Br_converted_to_reguar_br() {
		fxt.tst_Parse_page_wiki("</br>a"	, fxt.tkn_xnde_(0, 5), fxt.tkn_txt_(5, 6));
		fxt.tst_Parse_page_wiki("<br/>a"	, fxt.tkn_xnde_(0, 5), fxt.tkn_txt_(5, 6));
		fxt.tst_Parse_page_wiki("</br/>a"	, fxt.tkn_xnde_(0, 6), fxt.tkn_txt_(6, 7));
	}
	@Test  public void Table() {
		fxt.tst_Parse_page_wiki("a<table><tr><td>b</td></tr></table>c"
			, fxt.tkn_txt_ ( 0,  1)
	...
	@Test  public void SubSupMismatch() {
		fxt.tst_Parse_page_wiki_str("<sub>a</sup>", "<sub>a</sub>");
		fxt.tst_Parse_page_wiki_str("<sup>a</sub>", "<sup>a</sup>");
	}
...
//				)
	...
	@Test  public void No_wiki2() {
		fxt.Ctx().Para().Enabled_y_();
		fxt.ini_defn_add("nowiki_test", "<nowiki>#</nowiki>a");
		fxt.tst_Parse_page_all_str
			(	"{{nowiki_test}}"
			,	String_.Concat_lines_nl_skipLast
			(	"<p>#a"
	...
	@Test  public void Pre_and_html_chars() {// PURPOSE: <pre> should handle '"<> according to context
		fxt.tst_Parse_page_all_str("<pre>a&#09;b</pre>"			, "<pre>a&#09;b</pre>");					// known ncr/dec; embed and depend on browser transforming; EX: de.w:Wikipedia:Technik/Skin/Werkstatt
		fxt.tst_Parse_page_all_str("<pre>a&#9999999999;b</pre>"	, "<pre>a&amp;#9999999999;b</pre>");		// unknown ncr/dec; escape & (since browser cannot render);
		fxt.tst_Parse_page_all_str("<pre>a&#af ;b</pre>"		, "<pre>a&amp;#af ;b</pre>");				// unknown ncr/dec 2
		fxt.tst_Parse_page_all_str("<pre>a&#x9;b</pre>"			, "<pre>a&#x9;b</pre>");					// known ncr/hex
		fxt.tst_Parse_page_all_str("<pre>a&apos;b</pre>"		, "<pre>a&apos;b</pre>");					// known name; embed
		fxt.tst_Parse_page_all_str("<pre>a&apox;b</pre>"		, "<pre>a&amp;apox;b</pre>");				// unknown name; escape
		fxt.tst_Parse_page_all_str("<pre>&\"<></pre>"			, "<pre>&amp;&quot;&lt;&gt;</pre>");		// no ncr or name; escape; needed for <pre><img ...></pre>; EX.WP: Alt attribute
	}
	@Test  public void Nowiki_lnke() {	// EX.WP: Doomsday argument; <nowiki>[0,&nbsp;1]</nowiki>
		fxt.tst_Parse_page_wiki_str("a <nowiki>[0,&nbsp;1]</nowiki> b", "a [0,&nbsp;1] b");	// NOTE: not "0" + Byte_.XtoStr(160) + "1"; depend on browser to translate &nbsp;
	}
	...
	@Test  public void Xnde_whitelist() {
		fxt.tst_Parse_page_all_str("<span onload='alert()'></span>", "<span></span>");
	}
	@Test  public void Xnde_whitelist_pre() { // PURPOSE: <pre style="overflow:auto">a</pre> somehow becoming <prestyle="overflow:auto">a</pre>; Template:Infobox_country; ISSUE: old xatr code being triggered; PURPOSE:(2) style being stripped when it shouldn't be
		fxt.tst_Parse_page_all_str("<pre style=\"overflow:auto\">a</pre>", "<pre style=\"overflow:auto\">a</pre>");
	}
	@Test  public void Atrs_non_ws() {			// PURPOSE: <br$2/> is valid; symbols function as ws
		fxt.ini_Log_(Xop_xatr_parser.Log_invalid_atr).tst_Parse_page_wiki("<br$2/>"	, fxt.tkn_xnde_(0, 7).Atrs_rng_(3, 5));
	}
	...
	@Test  public void Sup_bug() {	// PURPOSE: occurred at ref of UK; a {{cite web|url=http://www.abc.gov/{{dead link|date=December 2011}}|title=UK}} b
		fxt.tst_Parse_page_wiki_str("x <b><sup>y</b> z", "x <b><sup>y</sup></b> z");
	}
	...
	@Test  public void Invalid_tag() {// PURPOSE: invalid tag shouldn't break parser; EX:w:Cullen_(surname); "http://www.surnamedb.com/Surname/Cullen<ref"
		fxt.tst_Parse_page_all_str("a<ref", "a&lt;ref");
	}	
	@Test  public void Xatr_nowiki() {
		fxt.tst_Parse_page_all_str("<ul id<nowiki>=</nowiki>\"a\" class<nowiki>=</nowiki>\"b\"><li><span class=\"c\">d</li></ul>", String_.Concat_lines_nl_skipLast
			(	"<ul id=\"a\" class=\"b\">"
	...
	@Test  public void List_always_separated_by_nl() {// PURPOSE: <li> should always be separated by nl, or else items will merge, creating long horizontal scroll bar; EX:w:Music
		fxt.Ctx().Para().Enabled_y_();
		fxt.tst_Parse_page_all_str("<ul><li>a</li><li>b</li></ul>"
			,	String_.Concat_lines_nl_skipLast
			(	"<ul>"
			,	"<li>a</li>"
			,	"<li>b</li></ul>"
	...
	@Test  public void Pre_nowiki() {	// PURPOSE: nowikis inside pre should be ignored; DATE:2013-03-30
		...
		fxt.tst_Parse_page_all_str("<pre><nowiki>a<nowiki>b</nowiki>c</nowiki></pre>"	, "<pre>&lt;nowiki&gt;abc&lt;/nowiki&gt;</pre>");	// nested; this is wrong, but leave for now; should be a<nowiki>b</nowiki>c
	}
	@Test  public void Id_encode() {
		fxt.tst_Parse_page_all_str("<div id=\"a b c\"></div>", "<div id=\"a_b_c\"></div>");
	}
	@Test  public void Style_invalid() {
		fxt.tst_Parse_page_all_str("<div style=\"url(bad)\"></div>", "<div></div>");
	}
	@Test   public void Javascript_in_syntaxhighlight() {
		fxt.tst_Parse_page_all_str("<syntaxhighlight><script>alert('fail');</script></syntaxhighlight>", "<pre style=\"overflow:auto;\">&lt;script&gt;alert('fail');&lt;/script&gt;</pre>");
	}
	...
	@Test  public void Nowiki_inside_code() {	// PURPOSE.fix:HtmlNcr-escaped refs were being ignored; caused by HtmlTidy fix for frwiki templates;DATE:2013-06-27
		fxt.tst_Parse_page_all_str("<code><nowiki>|:</nowiki></code>", "<code>|:</code>");
	}
	@Test  public void Li_dupe_list() {	// PURPOSE: ignore redundant li; EX: "* <li>"; http://it.wikipedia.org/wiki/Milano#Bibliographie; DATE:2013-07-23
		fxt.tst_Parse_page_all_str("* <li>x</li>", String_.Concat_lines_nl_skipLast
		(	"<ul>"
		,	"  <li> "
		,	"x"
		,	"  </li>"
...
//			fxt.tst_Parse_page_wiki_str("a<code><h1><code>b", "a<code>&lt;h1&gt;</code>b");
//		}
//		@Test  public void Ul_li_close_auto() {
//			fxt.ini_Log_(Xop_xnde_log.Auto_closing_section).tst_Parse_page_wiki("<ul><li>a<li>b</ul>"
...
//			fxt.ini_Log_(Xop_xnde_log.Auto_closing_section, Xop_xnde_log.Escaped_xnde).tst_Parse_page_wiki("<div><span></div></span>"
