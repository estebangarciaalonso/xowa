...
class Scrib_lib_message_data {
	...
	private static final Hash_adp_bry key_hash = new Hash_adp_bry(false).Add_str_byte("keys", Key_tid_keys).Add_str_byte("rawMessage", Key_tid_rawMessage).Add_str_byte("lang", Key_tid_lang).Add_str_byte("useDB", Key_tid_useDB).Add_str_byte("title", Key_tid_title).Add_str_byte("params", Key_tid_params);
	...
	private static final Hash_adp_bry fmt_hash = new Hash_adp_bry(false).Add_str_byte("parse", Fmt_tid_parse).Add_str_byte("text", Fmt_tid_text).Add_str_byte("plain", Fmt_tid_plain).Add_str_byte("escaped", Fmt_tid_escaped).Add_str_byte("parseAsBlock", Fmt_tid_parseAsBlock);
	public static final byte Check_tid_exists = 1, Check_tid_isBlank = 2, Check_tid_isDisabled = 3;
	private static final Hash_adp_bry check_hash = new Hash_adp_bry(false).Add_str_byte("exists", Check_tid_exists).Add_str_byte("isBlank", Check_tid_isBlank).Add_str_byte("isDisabled", Check_tid_isDisabled);
}
