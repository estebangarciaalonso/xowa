...
import gplx.xowa.apps.*; import gplx.xowa.files.cnvs.*;
public class Xof_img_mgr {
	...
	public int Thumb_w_img() {return thumb_w_img;} private int thumb_w_img = Thumb_w_img_const; public static final int Thumb_w_img_const = 220;
	public int Thumb_w_ogv() {return thumb_w_ogv;} private int thumb_w_ogv = Thumb_w_ogv_const; public static final int Thumb_w_ogv_const = 220;
