...
public class Nearby_mgr implements Xows_page {
	...
	Hash_adp_bry excluded = new Hash_adp_bry(false);
	Hash_adp_bry visited = new Hash_adp_bry(false);
...
//			wiki.ParsePage(page, false);	// do not clear else previous Search_text will be lost		
	...
	void Examine_page(OrderedHash src_pool){
...
//			}
	...
	void Examine_page(Xow_wiki wiki, Xoa_ttl ttl, ListAdp trail){
		byte[] ttl_bry = ttl.Page_db();
	...
	void Collect_lnkis(OrderedHash lnkis, Xop_tkn_itm tkn) {
