...
public interface Db_provider_mkr {
	Db_provider Load_or_make_(Io_url db_url, BoolRef created_ref);
}
class Db_provider_mkr_sqlite implements Db_provider_mkr {
	public Db_provider Load_or_make_(Io_url db_url, BoolRef created_ref) {return Sqlite_engine_.Provider_load_or_make_(db_url, created_ref);}
...
class Db_provider_mkr_mem implements Db_provider_mkr {
	...
	public Db_provider Load_or_make_(Io_url db_url, BoolRef create_ref) {create_ref.Val_(create); return null;}
