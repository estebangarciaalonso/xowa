...
public class Xog_history_itm {
	public Xog_history_itm(byte[] key, byte[] wiki_key, byte[] page_key, byte[] anch_key, byte[] qarg_key, byte[] redirect_force, String html_doc_pos) {
		this.key = key; this.wiki_key = wiki_key; this.page_key = page_key; this.qarg_key = qarg_key; this.anch_key = anch_key; this.redirect_force = redirect_force; this.html_doc_pos = html_doc_pos;
	...
	public static byte[] Build_key(byte[] wiki_key, byte[] page_key, byte[] anch_key, byte[] qarg_key, byte[] redirect_force) {
		return ByteAry_.Add_w_dlm(Byte_ascii.Pipe, wiki_key, page_key, anch_key, qarg_key, redirect_force);
	}
	public static final String Html_doc_pos_toc = "top";
	public static final Xog_history_itm Null = new Xog_history_itm(null, null, null, null, null, null, null);
}
