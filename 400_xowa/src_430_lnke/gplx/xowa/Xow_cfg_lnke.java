...
public class Xow_cfg_lnke {
	private ListAdp protocol_list = ListAdp_.new_();
	...
	private String[] protocol_ary = new String[] {"http://", "https://", "ftp://", "irc://", "gopher://", "telnet://", "nntp://", "worldwind://", "svn://", "git://", "mms://", "mailto:"}; // REF.MW:DefaultSettings|$wgUrlProtocols}; NOTE: removing "news:" because it breaks alias wikinews:
