...
public class Fsm_atr_mgr implements RlsAble {
	...
	public Fsm_atr_mgr Conn_load_(Fsm_abc_mgr abc_mgr, Db_conn conn, Io_url dir) {
		tbl.Conn_(conn, 1, Bool_.Y);
		this.itms = tbl.Select_all(abc_mgr, dir);
		this.itms_0 = this.itms[0];
		return this;
	}
	public Fsm_atr_mgr Conn_make_(Fsm_abc_mgr abc_mgr, Db_conn conn, Io_url dir) {
		tbl.Conn_(conn, 1, Bool_.Y);
		tbl.Create_table();
